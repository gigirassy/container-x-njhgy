...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-x-njhgy.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-x-njhgy.containers.anotherwebservice.com/
...
```
git clone git@github.com:gigirassy/container-x-njhgy.git
cd container-x-njhgy
```
...
```
docker attach container-x-njhgy
```
